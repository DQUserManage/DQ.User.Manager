...
#else
	typedef CBCGPDialog				CBaseDialog;
	typedef CBCGPFormView			CBaseFormView;
	typedef CDialogBar			    CBaseDialogBar;
	typedef CBCGPPropertyPage		CBasePropertyPage;
#endif
}
...
/*
#ifndef 
#define  EXPORT_GUI_BASE_CORE_CLASS
#
*/
...
*/
	 ...
	 */
	class  PaneItem : public PaneBase {
		friend class ETSLayoutMgr;
		friend class Pane;
	protected:
		/**
 ...
 */
class  ETSLayoutDialog : public ETSLayout::CBaseDialog, protected ETSLayoutMgr
{
// Construction
public:
 ...
 */
class  ETSLayoutFormView : public ETSLayout::CBaseFormView, public ETSLayoutMgr
{
// Construction
 ...
 * ETSLayoutDialogBar
 */
class  ETSLayoutDialogBar : public ETSLayout::CBaseDialogBar, protected ETSLayoutMgr
{
// Construction
public:
#ifdef CS_HELP
 ...
 */
class  ETSLayoutPropertySheet : public CPropertySheet, protected ETSLayoutMgr
{
 ...
 */
class  ETSLayoutPropertyPage : public ETSLayout::CBasePropertyPage, protected ETSLayoutMgr
{
friend class ETSLayoutPropertySheet;
